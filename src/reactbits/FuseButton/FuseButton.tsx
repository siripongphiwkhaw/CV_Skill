...
// Inline glyphs instead of the original icon package dependency.
const glyph = (d: string, strokeWidth: number) => (
...
const PlusGlyph = glyph('M12 5v14M5 12h14', 2);
const UndoGlyph = glyph('M3 7v6h6M3 13a9 9 0 1 0 3-7.2', 2);
const TickGlyph = glyph('M20 6 9 17l-5-5', 2.2);
...
const FuseButton: React.FC<FuseButtonProps> = ({
  ...
  const actionIcon = icon ?? PlusGlyph;
